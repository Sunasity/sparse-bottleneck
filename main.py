...
parser.add_argument('--finetune_lr', '--finetune-learning-rate', default=2e-4, type=float,
                    metavar='FT-LR', help='initial learning rate for finetune', dest='finetune_lr')
parser.add_argument('--lr_decay', default=30, type=float,
                    metavar='LR_D', help='epoch of learning rate decay', dest='lr_decay')
...
def save_checkpoint(state, is_best, current=None, filename='checkpoint.pth.tar'):
